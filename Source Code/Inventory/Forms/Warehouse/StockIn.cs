...
{
    /// <summary>
    /// Summary description for StockIn.
    /// </summary>
    public class StockIn : BaseWarehouse
    {

        private DevExpress.XtraGrid.GridControl grdDetails;
        private DevExpress.XtraGrid.Views.Grid.GridView gridView1;
        private TextEdit txtStockIn;
        private Label lblStockIn;
        ...
        private StockInModel model = new StockInModel();

        private bool isBinding = false;
        /// <summary>
        /// Get/set data model StockIn 
        /// </summary>
        public StockInModel DataModel
        {
            get { return model; }
            set { model = value; }
        }
        ...
        {
            this.txtStockIn = new DevExpress.XtraEditors.TextEdit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.txtStockIn.Properties)).BeginInit();
            ...
            // txtStockIn
            // 
            this.txtStockIn.Location = new System.Drawing.Point(83, 13);
            this.txtStockIn.Name = "txtStockIn";
            this.txtStockIn.Size = new System.Drawing.Size(184, 21);
            this.txtStockIn.TabIndex = 1;
            // 
            // lblStockIn
            // 
            this.lblStockIn.AutoSize = true;
            this.lblStockIn.Location = new System.Drawing.Point(9, 16);
            this.lblStockIn.Name = "lblStockIn";
            this.lblStockIn.Size = new System.Drawing.Size(38, 14);
            this.lblStockIn.TabIndex = 17;
            this.lblStockIn.Text = "Name";
            // 
            // grdDetails
            // 
            ...
            this.Controls.SetChildIndex(this.lblStockIn, 0);
            this.Controls.SetChildIndex(this.txtStockIn, 0);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.txtStockIn.Properties)).EndInit();
        ...
        /// </summary>
        /// <param name="objModel">StockInModel</param>
        public void BindData(StockInModel objModel)
        {
            isBinding = true;
            ...
            if (objModel == null)
            {
                model = new StockInModel();
                model.Details = Mediator.GetInstance().GetEmptyStockInDetails();
            }
            else
            {
                model = objModel;
            ...
            this.txtStockIn.Text = model.Name;
            ...
            gridView.Columns["StockInID"].Visible = false;            
        ...
        protected override bool Validate()
        {
            ...
            if (!objValidator.IsNonEmpty("Name", this.txtStockIn.Text))
            {
                txtStockIn.Focus();
                return false;
            }
            if (Toolkit.DbToolKit.IsDataOfSqlExists("SELECT ID,Name FROM StockInMaster WHERE Name = '" + txtStockIn.Text.Trim() + "' AND ID <> '" + this.DataModel.Id + "'"))
            {
        ...
        {
            model.Name = this.txtStockIn.Text;
