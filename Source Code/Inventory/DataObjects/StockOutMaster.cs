///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'StockOutMaster'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'StockOutMaster'.
	/// </summary>
	public class StockOutMaster : DBInteractionBase
	{
		...
		public override bool Insert(SqlCommand scmCmdToExecute)
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_StockOutMaster_Insert]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_StockOutMaster_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("StockOutMaster::Insert::Error occured.", ex);
			}
			finally
			{
			}
		...
		{
			scmCmdToExecute.Parameters.Clear();
			scmCmdToExecute.CommandText = "dbo.[pr_StockOutMaster_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			try
			{
				scmCmdToExecute.Parameters.Add(new SqlParameter("@sID", SqlDbType.VarChar, 36, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sID));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_StockOutMaster_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("StockOutMaster::Update::Error occured.", ex);
			}
			finally
			{
			}
		...
		{
			scmCmdToExecute.Parameters.Clear();
			scmCmdToExecute.CommandText = "dbo.[pr_StockOutMaster_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			try
			{
				scmCmdToExecute.Parameters.Add(new SqlParameter("@sID", SqlDbType.VarChar, 36, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sID));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_StockOutMaster_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("StockOutMaster::Delete::Error occured.", ex);
			}
			finally
			{
			}
		...
		public override DataTable SelectOne()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_StockOutMaster_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("StockOutMaster");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_StockOutMaster_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("StockOutMaster::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_StockOutMaster_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("StockOutMaster");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_StockOutMaster_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("StockOutMaster::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
