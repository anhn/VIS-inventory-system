...
namespace Inventory.DataObjects
{
	...
	public class StockTransferMaster : DBInteractionBase
	{
        ...
        /// <summary>
        /// This method is to check the Stock with given name exist or nor
        /// </summary>
        /// <param name="strName"></param>
        /// <returns></returns>
        public bool IsExistStockTransferMaster(string strName)
        {
            try
            {
                string strSQL = String.Format("Select * From StockTransferMaster Where StockTransferMaster.Name = '{0}'", strName);
            ...
            {
                throw new Exception(String.Format("Error occured while checking StockTransferMaster. {0}", oExc.Message));
            }
