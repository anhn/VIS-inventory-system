...
{
    public class DeleteProductFamilyCommand : Command
    {
        private string strProductFamilyID = string.Empty;

        public string ProductFamilyID
        {
            get { return strProductFamilyID; }
            set { strProductFamilyID = value; }
        }
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                pr.DBCommand = objCmd;
                pr.DeleteID = strProductFamilyID;

                pr.DeleteProductFamily();
